      ...
      <div  className="flex flex-col md:flex-row gap-10 px-6 md:px-16 lg:px-32 pt-14 mb-20">
        <div className="flex-1">
          <div className="flex items-center justify-between mb-8 border-b border-gray-500/30 pb-6">
            ...
            <p  className="text-lg md:text-xl text-gray-500/80">{count} Items</p>
          </div>
    ...
    Object.keys(cartItems).map((itemId) => {
      ...
      return (
                    <tr key={itemId}>
                      ...
                      <td className="py-4 md:px-4 px-1 text-gray-600">${Math.floor(product.offerPrice * cartItems[itemId])}</td>
                    </tr>
                  );
                })
              ) : (
                <tr>
                  <td colSpan="4" className="border-t border-gray-500/20 text-center p-5">
                    Ooops! Cart is empty
                  </td>
                </tr>
              )}
